				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">五分彩</div>';
...
move.five_currentTime=move.server+'/api/gfFive_sessionInfo';
move.five_betPanel=move.server+'/api/gfFive_betPanel';
move.five_bet=move.server+'/api/gfFive_bet';
move.five_trend=move.server+"/api/gfFive_trend";
