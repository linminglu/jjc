				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">北京快3</div>';
...
move.bjK3_currentTime=move.server+"/api/gfBjK3_sessionInfo";
...
move.bjK3_hotRanking=move.server+"/api/gfBjK3_hotRanking";
