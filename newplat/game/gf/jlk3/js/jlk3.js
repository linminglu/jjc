				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">吉林快3</div>';
...
move.jlK3_currentTime=move.server+"/api/gfJlK3_sessionInfo";
...
move.jlK3_hotRanking=move.server+"/api/gfJlK3_hotRanking";
