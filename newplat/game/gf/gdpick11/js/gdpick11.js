				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">广东11选5</div>';
...
move.gdPick11_currentTime=move.server+"/api/gfGdPick11_sessionInfo";
...
move.gdPick11_hotRanking=move.server+"/api/gfGdPick11_hotRanking";
