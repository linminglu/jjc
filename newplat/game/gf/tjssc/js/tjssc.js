				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">天津时时彩</div>';
...
move.tjSsc_currentTime=move.server+'/api/gfTjSsc_sessionInfo';
move.tjSsc_betPanel=move.server+'/api/gfTjSsc_betPanel';
move.tjSsc_bet=move.server+'/api/gfTjSsc_bet';
move.tjSsc_trend=move.server+"/api/gfTjSsc_trend";
//move.tjSsc_winRanking=move.server+'/api/tjSsc_winRanking';
move.tjSsc_openList=move.server+'/api/gfTjSsc_openList';
move.tjSsc_gamePlayType=move.server+'/api/gfTjSsc_gamePlayType';
move.tjSsc_latestLottery=move.server+'/api/gfTjSsc_latestLottery';
