				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">广西快3</div>';
...
move.gxK3_currentTime=move.server+"/api/gfGxK3_sessionInfo";
...
move.gxK3_hotRanking=move.server+"/api/gfGxK3_hotRanking";
