				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">山东11选5</div>';
...
move.sdPick11_currentTime=move.server+"/api/gfSdPick11_sessionInfo";
...
move.sdPick11_hotRanking=move.server+"/api/gfSdPick11_hotRanking";
