				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">江西11选5</div>';
...
move.jxPick11_currentTime=move.server+"/api/gfJxPick11_sessionInfo";
...
move.jxPick11_hotRanking=move.server+"/api/gfJxPick11_hotRanking";
