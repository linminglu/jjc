				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">新疆时时彩</div>';
...
move.xjSsc_currentTime=move.server+'/api/gfXjSsc_sessionInfo';
move.xjSsc_betPanel=move.server+'/api/gfXjSsc_betPanel';
move.xjSsc_bet=move.server+'/api/gfXjSsc_bet';
move.xjSsc_trend=move.server+"/api/gfXjSsc_trend";
//move.xjSsc_winRanking=move.server+'/api/xjSsc_winRanking';
move.xjSsc_openList=move.server+'/api/gfXjSsc_openList';
move.xjSsc_gamePlayType=move.server+'/api/gfXjSsc_gamePlayType';
move.xjSsc_latestLottery=move.server+'/api/gfXjSsc_latestLottery';
