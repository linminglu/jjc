				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">江西快3</div>';
...
move.jxK3_currentTime=move.server+"/api/gfJxK3_sessionInfo";
...
move.jxK3_hotRanking=move.server+"/api/gfJxK3_hotRanking";
