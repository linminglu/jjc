				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">安徽快3</div>';
...
move.ahK3_currentTime=move.server+"/api/gfAhK3_sessionInfo";
...
move.ahK3_hotRanking=move.server+"/api/gfAhK3_hotRanking";
