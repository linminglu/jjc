				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">三分彩</div>';
...
move.three_currentTime=move.server+'/api/gfThree_sessionInfo';
move.three_betPanel=move.server+'/api/gfThree_betPanel';
move.three_bet=move.server+'/api/gfThree_bet';
move.three_trend=move.server+"/api/gfThree_trend";
