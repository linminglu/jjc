				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">上海11选5</div>';
...
move.shPick11_currentTime=move.server+"/api/gfShPick11_sessionInfo";
...
move.shPick11_hotRanking=move.server+"/api/gfShPick11_hotRanking";
