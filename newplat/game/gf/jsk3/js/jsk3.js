				...
				if(code=="200"){
					...
					if(items.length>0){
						for(var i=0;i<items.length;i++){
							...
							html=html+'<li class="mui-table-view-cell"><div class="title-box"><div class="title">江苏快3</div>';
...
move.jsK3_currentTime=move.server+"/api/gfJsK3_sessionInfo";
...
move.jsK3_hotRanking=move.server+"/api/gfJsK3_hotRanking";
