...
move.jiangsuk3_currentTime=move.server+'/api/bjK3_currentTime';
move.jiangsuk3_betPanel=move.server+'/api/bjK3_betPanel';
move.jiangsuk3_bet=move.server+'/api/bjK3_bet';
move.jiangsuk3_trend=move.server+'/api/bjK3_trend';
move.jiangsuk3_hotRanking=move.server+'/api/bjK3_hotRanking';
move.jiangsuk3_openList=move.server+'/api/bjK3_openList';
