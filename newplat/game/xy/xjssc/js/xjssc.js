...
move.cqSSc_bet=move.server+'/api/xjSsc_bet';
move.cqSSc_trend=move.server+'/api/xjSsc_trend';
move.cqSSc_hotRanking=move.server+'/api/xjSsc_hotRanking';
move.cqSSc_openList=move.server+'/api/xjSsc_openList';
