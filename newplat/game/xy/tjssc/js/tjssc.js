...
move.cqSSc_bet=move.server+'/api/tjSsc_bet';
move.cqSSc_trend=move.server+'/api/tjSsc_trend';
move.cqSSc_hotRanking=move.server+'/api/tjSsc_hotRanking';
move.cqSSc_openList=move.server+'/api/tjSsc_openList';
