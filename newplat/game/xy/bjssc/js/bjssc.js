...
move.cqSSc_bet=move.server+'/api/bjSsc_bet';
move.cqSSc_trend=move.server+'/api/bjSsc_trend';
move.cqSSc_hotRanking=move.server+'/api/bjSsc_hotRanking';
move.cqSSc_openList=move.server+'/api/bjSsc_openList';
