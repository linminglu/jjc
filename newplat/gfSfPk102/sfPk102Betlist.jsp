...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
    	...
    	期号:<html:text property="sessionNo"/>	
			<span>时间范围：<html:text property="startDate" name="sfPk102Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="sfPk102Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty sfPk102Form.gfSfPk102Dto}">
	<tr style="background:#ddd">
		<td colspan="3"></td>
		<td>合计</td>
		<td><bean:write name="sfPk102Form" property="gfSfPk102Dto.totalPoint"/></td>
		<td><bean:write name="sfPk102Form" property="gfSfPk102Dto.winCash"/></td>
		<td><bean:write name="sfPk102Form" property="gfSfPk102Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
