...
<body>
<html:form action="/sflhcAction.do?method=betList">
<html:hidden property="startIndex" name="sflhcForm"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
    	<!-- 
			<span>时间范围：<html:text property="startDate" name="sflhcForm" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="sflhcForm" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		&nbsp;
    	 -->	
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty sflhcForm.sflhcDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="sflhcForm" property="sflhcDto.totalPoint"/></td>
		<td><bean:write name="sflhcForm" property="sflhcDto.winCash"/></td>
		<td><bean:write name="sflhcForm" property="sflhcDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
