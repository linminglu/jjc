...
<body>
<html:form action="/bjLu28Action.do?method=betList">
<html:hidden property="startIndex" name="bjLu28Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>
    	<!-- 			
    	    <span>开始时间：<html:text property="startDate" name="bjLu28Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>结束时间：<html:text property="endDate" name="bjLu28Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    	 -->	
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty bjLu28Form.bjlu28Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="bjLu28Form" property="bjlu28Dto.totalPoint"/></td>
		<td><bean:write name="bjLu28Form" property="bjlu28Dto.winCash"/></td>
		<td><bean:write name="bjLu28Form" property="bjlu28Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
