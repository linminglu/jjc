...
(function($){
	$.fn.mailAutoComplete = function(options){
		var defaults = {
			...
			mailArr: ["qq.com","gmail.com","126.com","163.com","hotmail.com","yahoo.com","yahoo.com.cn","live.com","live.cn","sohu.com","sina.com"], //邮件数组
		...
		$(this).each(function(){
			...
			var w = that.outerWidth()-2, h = that.outerHeight(); //获取当前对象（即文本框）的宽高,宽度减2是去掉外层边框的2px
			//样式的初始化
