if(navigator.userAgent.indexOf("Mobile")>-1) location.replace("/game");
//jQuery.timers 1.2
...
document.write("<script type='text/javascript' src='/js/site/'></script>");
var move = {};
//分页的页码
move.pageIndex=0;
//缓存存储时间，毫秒
move.storageTime=3600000;
...
move.lotteryNotice=move.server+'/api/baseData_lotteryNotice';
move.winRank=move.server+'/api/baseData_winRank';
move.joinHall=move.server+'/api/baseData_joinHall';
move.lotteryDraw=move.server+'/api/baseData_lotteryDraw';
move.lotteryNameAndType=move.server+'/api/baseData_lotteryNameAndType';
move.baseData_noticeOrHelp=move.server+'/api/baseData_noticeOrHelp';
move.baseData_newsInfo=move.server+'/api/baseData_newsInfo';
move.baseData_activitie=move.server+'/api/baseData_activitie';
move.messageList=move.server+'/api/baseData_messageList';
move.messageView=move.server+'/api/baseData_messageDetail';
move.payQRCode=move.server+'/api/baseData_payQRCode';
move.promotionList=move.server+'/api/lottery_promotionList';
move.gameOption=move.server+'/api/baseData_gameOption';// 彩种玩法
...
move.bankMsg=move.server+'/api/baseData_bankMsg';
move.cash_pointExchange=move.server+'/api/cash_pointExchange';


move.rechargeOfflineSubmit=move.server+'/api/recharge_offlineSubmit';
move.rechargeList=move.server+'/api/recharge_list';
move.rechargeList2=move.server+'/api/recharge_list2';
move.rechargeSubmit=move.server+'/api/recharge_submit';
...
move.userinfo=move.server+'/api/user_userInfo';
move.userSave=move.server+'/api/user_save';
move.changePwd=move.server+'/api/user_changePwd';
move.changeCashPwd=move.server+'/api/user_cashPassword';

move.bindBank=move.server+'/api/cash_bindSubmit';
...
move.newslist=move.server+'/api/baseData_newslist';
move.newsView=move.server+'/api/baseData_newsView';
move.baseData_joinHall=move.server+'/api/baseData_joinHall';
move.baseData_jointBet=move.server+'/api/baseData_jointBet';
move.baseData_jointBetDetail=move.server+'/api/baseData_jointBetDetail';
move.baseData_gaBetDetail=move.server+'/api/baseData_gaBetDetail';

move.baseData_accountDetails=move.server+'/api/baseData_accountDetails';
move.baseData_pointDetails=move.server+'/api/baseData_pointDetails';


move.ssq_gamePlayType=move.server+'/api/gfSsq_gamePlayType';
move.ssq_betPanel=move.server+'/api/gfSsq_betPanel';
move.ssq_sessionInfo=move.server+'/api/gfSsq_sessionInfo';
move.ssq_openList=move.server+'/api/gfSsq_openList';
move.ssq_bet=move.server+'/api/gfSsq_bet';
move.ssq_trend=move.server+'/api/gfSsq_trend';

move.three_gamePlayType=move.server+'/api/gfThree_gamePlayType';
move.three_betPanel=move.server+'/api/gfThree_betPanel';
move.three_sessionInfo=move.server+'/api/gfThree_sessionInfo';
move.three_openList=move.server+'/api/gfThree_openList';
move.three_latestLottery=move.server+'/api/gfThree_latestLottery';
move.three_bet=move.server+'/api/gfThree_bet';
move.three_winRanking=move.server+'/api/gfThree_winRanking';

move.five_gamePlayType=move.server+'/api/gfFive_gamePlayType';
move.five_betPanel=move.server+'/api/gfFive_betPanel';
move.five_sessionInfo=move.server+'/api/gfFive_sessionInfo';
move.five_openList=move.server+'/api/gfFive_openList';
move.five_latestLottery=move.server+'/api/gfFive_latestLottery';
move.five_bet=move.server+'/api/gfFive_bet';
move.five_winRanking=move.server+'/api/gfFive_winRanking';

//move.jxPick11_gamePlayType=move.server+'/api/jxPick11_gamePlayType';
//move.jxPick11_betPanel=move.server+'/api/jxPick11_betPanel';
//move.jxPick11_sessionInfo=move.server+'/api/jxPick11_sessionInfo';
...
//move.jxPick11_winRanking=move.server+'/api/jxPick11_winRanking';
//move.jxPick11_trend=move.server+'/api/jxPick11_trend';

//move.sdPick11_gamePlayType=move.server+'/api/sdPick11_gamePlayType';
//move.sdPick11_betPanel=move.server+'/api/sdPick11_betPanel';
//move.sdPick11_sessionInfo=move.server+'/api/sdPick11_sessionInfo';
...
//move.sdPick11_winRanking=move.server+'/api/sdPick11_winRanking';
//move.sdPick11_trend=move.server+'/api/sdPick11_trend';


//move.jsK3_gamePlayType=move.server+'/api/jsK3_gamePlayType';
//move.jsK3_betPanel=move.server+'/api/jsK3_betPanel';
//move.jsK3_sessionInfo=move.server+'/api/jsK3_sessionInfo';
//move.jsK3_openList=move.server+'/api/jsK3_openList';
//move.jsK3_latestLottery=move.server+'/api/jsK3_latestLottery';
//move.jsK3_bet=move.server+'/api/jsK3_bet';
//move.jsK3_winRanking=move.server+'/api/jsK3_winRanking';
//move.jsK3_trend=move.server+'/api/jsK3_trend';

//zhoushitu
move.cqSsc_trendWeb=move.server+'/api/gfCqSsc_trendWeb';
move.bjSsc_trendWeb=move.server+'/api/gfBjSsc_trendWeb';
move.tjSsc_trendWeb=move.server+'/api/gfTjSsc_trendWeb';
move.xjSsc_trendWeb=move.server+'/api/gfXjSsc_trendWeb';
move.five_trendWeb=move.server+'/api/gfFive_trendWeb';
move.three_trendWeb=move.server+'/api/gfThree_trendWeb';
...
var baseObj={
	...
	mw:function(map){
		...
		//if(mw.indexOf("bet")>-1) mui.alert(mw);
		if(mw!=''){
			mw=encryptByDES(mw);
			//第二次整体编码
			mw=encodeURI(mw);
...
var timerObj={
	...
	init:function(second,source){//初始化，封盘倒计时
		...
		if(timerObj.rest==0){
			...
			timerxiazhu=null;
			if(source=='timer-ssq'){
				console.warn('此处调用双色球封盘方法');
				lotteryObj.seal();
			}else if(source=='timer-wufencai'){
				console.warn('此处调用五分彩封盘方法');
				lotteryObj.seal();
			}else if(source=='timer-sanfencai'){
				console.warn('此处调用三分彩封盘方法');
				lotteryObj.seal();
	...
	open:function(second,source){//开奖倒计时
		...
		if(timerObj.openrest==0){
			...
			timeropen=null;
			if(source=='timer-ssqopen'){
				console.warn('此处调用双色球开奖方法');
				lotteryObj.open();
			}else if(source=='timer-wufencaiopen'){
				console.warn('此处调用五分彩开奖方法');
				lotteryObj.open();
			}else if(source=='timer-sanfencaiopen'){
				console.warn('此处调用三分彩开奖方法');
				lotteryObj.open();
...
function zhuiHaoObj(sessionNo,multiple){
	var obj=new Object(); 
	obj.s=sessionNo; 
	obj.m=multiple; 
	return obj; 
...
function betBallObj(betting,type){
	var obj=new Object(); 
	obj.b=betting; 
	obj.t=type; 
	return obj; 
...
//		$('.topline .loginline').show();
		...
		$(".flex-line").append('<div class="login-line fr">'
				...
				+'<input type="text" placeholder="手机号/ID号" name="loginName">'
				+'</div>'
				...
				+'</div>'
				+'</div>');
		$('.logined').html('<span class="welcome">'+move.siteName+'【'+move.siteDomain+'】</span>'
    ...
    $.ajax({
		...
		success: function(ret){
			...
			if(code=='200'){
				...
				var onlineServer=result.onlineServerUrl;
				
				var arr = $(".fr a");
				for(var i = 0;i<arr.length;i++){
					var tmp = arr[i];
					if($(tmp).text()=="在线客服"){
						$(tmp).attr("href",onlineServer);
						$(tmp).attr("target","_blank");
					}
				}
				if($(".qq-customer")){
					$(".qq-customer").attr("href",qqServerUrl);
					$(".qq-customer").attr("target","_blank");
				}
				if($(".on-line-customer")){
					$(".on-line-customer").attr("href",onlineServer);
					$(".on-line-customer").attr("target","_blank");
				}
		...
		success: function(ret){
			...
			if(code=='200'){
				if(items.length>0){
					...
					if(count>0){
						var shtml = "<span class=\"mui-badge mui-badge-danger\">"+count+"</span>";
						if($(".user-info-line")&&$(".user-info-line").length>0){
							
							$(".user-info-line").prepend("<a href=\"/user/message\"><span class=\"message\">"+shtml+"新消息</span></a>");
						}
						if($("ul.settingbox")&&$("ul.settingbox").length>0){
							$("ul.settingbox a").each(function(){
								if($(this).text()=="我的消息"){
									// $(this).text("我的消息"+shtml);
									$(this).after(shtml);
								}
							});
						}
...
move.footer = function(){
	var shtml = "";
	shtml += "<p>ICP备案号：<a class=\"icp\" href=\"http://www.miibeian.gov.cn/\" rel=\"nofollow\"></a> | 版权所有："+move.siteName+"</p>";
	shtml += "<p class=\"pg-img\"><a href=\"#\"><img src=\"/images/pg/pg_gray.png\"></a></p>";
	$(".copyright").html(shtml);
}
$(function(){
	move.footer();
});