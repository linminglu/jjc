...
var gsOutOfRange="日期区域错误";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gcCalBG="#ECF7FF";	// the background color of the outer calendar panel.日历面板背景
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >今天 : "+gToday[0]+"年"+gMonths[gToday[1]-1]+""+gToday[2]+"号</A>";	// the content of the bottom section.
...
var gcCellBG="#FFFFFF";	// default background color of the cells. Use "" for transparent!!!//工作日日期背景
