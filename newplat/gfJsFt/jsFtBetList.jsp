...
<body>
<html:form action="/jsFtAction.do?method=betList">
<html:hidden property="startIndex" name="jsFtForm"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
			<span>时间范围：<html:text property="startDate" name="jsFtForm" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="jsFtForm" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty jsFtForm.gfJsFtDto}">
	<tr style="background:#ddd">
		<td colspan="3"></td>
		<td>合计</td>
		<td><bean:write name="jsFtForm" property="gfJsFtDto.totalPoint"/></td>
		<td><bean:write name="jsFtForm" property="gfJsFtDto.winCash"/></td>
		<td><bean:write name="jsFtForm" property="gfJsFtDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
