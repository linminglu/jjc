...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty bjPk10Form.bjPk10Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="bjPk10Form" property="bjPk10Dto.totalPoint"/></td>
		<td><bean:write name="bjPk10Form" property="bjPk10Dto.winCash"/></td>
		<td><bean:write name="bjPk10Form" property="bjPk10Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
