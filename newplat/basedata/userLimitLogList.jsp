...
<html:form action="/baseDataAction.do?method=userLimitLogList">
<html:hidden property="startIndex" name="baseDataForm"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
		    <span>用户ID：<html:text property="uid" name="baseDataForm"/></span>
...
<pg:pager 
	...
	scope="request"> 
	<pg:param name="method" value="userLimitLogList"/>
