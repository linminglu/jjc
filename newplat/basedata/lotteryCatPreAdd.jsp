...
<body>
<div class="bread">彩种管理   &raquo;新增彩种</div>
<html:form action="baseDataAction.do?method=lotteryCatAdd" focus="user.loginName" onsubmit="return formSubmit();" enctype="multipart/form-data">
...
<table width="100%" class="tblistadd" border="0" cellpadding="0" cellspacing="1">
	<tr class="tr-color-body">
		<th align="right">游戏名字</th>
      	<td>
        	<html:text property="gasInfo.gameTitle" name="baseDataForm"/>
      	</td>
    </tr>
    <tr class="tr-color-body">
      	<th align="right">游戏类型</th>
      	<td>
        	<html:text property="gasInfo.gameType" name="baseDataForm"/>
      	</td>
    </tr>
    <tr class="tr-color-body">
      	<th align="right">代码</th>
      	<td>
       		<html:text property="gasInfo.gameCode" name="baseDataForm" maxlength="50"/>
      	</td>
    </tr>
    <tr class="tr-color-body">
      	<th align="right">设置</th>
      	<td>
       		<html:text property="gasInfo.gameSet" name="baseDataForm" maxlength="50"/>
      	</td>
    </tr>
    ...
    <tr class="tr-color-body">
      	...
      	<td>
       		<html:text property="gasInfo.des" name="baseDataForm" maxlength="100" />
      	</td>
    </tr>
     <tr class="tr-color-body">
      	<th align="right">每日开奖期数说明</th>
      	<td>
       		<html:text property="gasInfo.exp" name="baseDataForm" maxlength="100" />
      	</td>
    </tr>
