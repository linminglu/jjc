...
<body>
<div class="bread">类型管理  &raquo;团购栏目二级类型列表</div>
<html:form action="/typeAction.do?method=groupSecond">
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	...
	<tr class="tr-color-body" onmousemove="this.style.background='#EEE'" onmouseout="this.style.background='#FFF'">
	   ...
	   <td align="center">
	    	...
	    	<a href="javascript:if(confirm('确实要向上吗？')){window.location='typeAction.do?method=groupSotr&tid=<bean:write name="item" property="tid"/>&flag=1'}" class="button">上</a>
	    	<a href="javascript:if(confirm('确实要向下吗？')){window.location='typeAction.do?method=groupSotr&tid=<bean:write name="item" property="tid"/>&flag=0'}" class="button">下</a>
	    </td>
