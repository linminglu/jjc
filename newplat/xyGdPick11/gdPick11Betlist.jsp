...
<body>
<html:form action="/gdPick11Action.do?method=betList">
<html:hidden property="startIndex" name="gdPick11Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
    	<!--
			<span>时间范围：<html:text property="startDate" name="gdPick11Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="gdPick11Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty gdPick11Form.gdpick11Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="gdPick11Form" property="gdpick11Dto.totalPoint"/></td>
		<td><bean:write name="gdPick11Form" property="gdpick11Dto.winCash"/></td>
		<td><bean:write name="gdPick11Form" property="gdpick11Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
