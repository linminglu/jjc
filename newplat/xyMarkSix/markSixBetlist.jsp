...
<body>
<html:form action="/markSixAction.do?method=betList">
<html:hidden property="startIndex" name="markSixForm"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
    	<!-- 
			<span>时间范围：<html:text property="startDate" name="markSixForm" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="markSixForm" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		&nbsp;
    	 -->	
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty markSixForm.marSixDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="markSixForm" property="marSixDto.totalPoint"/></td>
		<td><bean:write name="markSixForm" property="marSixDto.winCash"/></td>
		<td><bean:write name="markSixForm" property="marSixDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
