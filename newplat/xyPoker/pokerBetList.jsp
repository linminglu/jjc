...
<body>
<html:form action="/pokerAction.do?method=betList">
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
    	...
    	期号:<html:text property="sessionNo"/>
    		<!--
			<span>时间范围：<html:text property="startDate" name="pokerForm" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="pokerForm" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty pokerForm.pokerDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="pokerForm" property="pokerDto.totalPoint"/></td>
		<td><bean:write name="pokerForm" property="pokerDto.winCash"/></td>
		<td><bean:write name="pokerForm" property="pokerDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
