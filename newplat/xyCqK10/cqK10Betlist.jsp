...
<body>
<html:form action="/cqK10Action.do?method=betList">
<html:hidden property="startIndex" name="cqK10Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
    	<!--
			<span>时间范围：<html:text property="startDate" name="cqK10Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="cqK10Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty cqK10Form.cqk10Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="cqK10Form" property="cqk10Dto.totalPoint"/></td>
		<td><bean:write name="cqK10Form" property="cqk10Dto.winCash"/></td>
		<td><bean:write name="cqK10Form" property="cqk10Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
