...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty jsftForm.jsftDTO}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="jsftForm" property="jsftDTO.totalPoint"/></td>
		<td><bean:write name="jsftForm" property="jsftDTO.winCash"/></td>
		<td><bean:write name="jsftForm" property="jsftDTO.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
