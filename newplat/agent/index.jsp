...
<div class="content">
	<header class="title">代理商登录</header>
	<div class="box">
		<p class="title"><span>Account</span> </p>
		<div class="from">
			<form name="loginForm" target="_top" onsubmit="return submitForm()" method="post" action="/permission/loginAction.do?method=loginAgent">
			<div class="item">
