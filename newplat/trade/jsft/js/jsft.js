				...
				if(code=='200'){
					...
					if(length==0){
						...
						for (var i = 0; i < resultItems.length; i++) {
							...
							html=html+'<span class="num '+className+' jsft_num">'+num+'</span>';
						}
...
move.jsft_gamePlayType=move.server+'/api/gfJsFt_gamePlayType';
move.jsft_betPanel=move.server+'/api/gfJsFt_betPanel';
move.jsft_sessionInfo=move.server+'/api/gfJsFt_sessionInfo';
move.jsft_openList=move.server+'/api/gfJsFt_openList';
move.jsft_latestLottery=move.server+'/api/gfJsFt_latestLottery';
move.jsft_bet=move.server+'/api/gfJsFt_bet';
move.jsft_winRanking=move.server+'/api/gfJsFt_winRanking';
move.jsft_trend=move.server+'/api/gfJsFt_trend';
