				...
				if(code=='200'){
					...
					if(length==0){
						if(timeropenresult==null){
							timeropenresult=window.setInterval(function(){timerObj.result('timer-jxk3open');},timerObj.intervalAPI);
						}
					}else{
					...
					if(timerxiazhu==null){
						timerxiazhu=window.setInterval(function(){timerObj.init(timerObj.rest,'timer-jxk3');},timerObj.interval); 
					}
					if(timeropen==null){
						timeropen=window.setInterval(function(){timerObj.open(timerObj.openrest,'timer-jxk3open');},timerObj.interval);
					}
...
move.jxK3_gamePlayType=move.server+'/api/gfJxK3_gamePlayType';
move.jxK3_betPanel=move.server+'/api/gfJxK3_betPanel';
move.jxK3_sessionInfo=move.server+'/api/gfJxK3_sessionInfo';
move.jxK3_openList=move.server+'/api/gfJxK3_openList';
move.jxK3_latestLottery=move.server+'/api/gfJxK3_latestLottery';
move.jxK3_bet=move.server+'/api/gfJxK3_bet';
move.jxK3_winRanking=move.server+'/api/gfJxK3_winRanking';
move.jxK3_trend=move.server+'/api/gfJxK3_trend';
