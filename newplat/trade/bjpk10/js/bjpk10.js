				...
				if(code=='200'){
					...
					if(length==0){
						...
						for (var i = 0; i < resultItems.length; i++) {
							...
							html=html+'<span class="num '+className+' bjpk10_num">'+num+'</span>';
						}
...
move.bjpk10_gamePlayType=move.server+'/api/gfBjPk10_gamePlayType';
move.bjpk10_betPanel=move.server+'/api/gfBjPk10_betPanel';
move.bjpk10_sessionInfo=move.server+'/api/gfBjPk10_sessionInfo';
move.bjpk10_openList=move.server+'/api/gfBjPk10_openList';
move.bjpk10_latestLottery=move.server+'/api/gfBjPk10_latestLottery';
move.bjpk10_bet=move.server+'/api/gfBjPk10_bet';
move.bjpk10_winRanking=move.server+'/api/gfBjPk10_winRanking';
