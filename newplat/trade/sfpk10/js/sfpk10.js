				...
				if(code=='200'){
					...
					if(length==0){
						...
						for (var i = 0; i < resultItems.length; i++) {
							...
							html=html+'<span class="num '+className+' sfpk10_num">'+num+'</span>';
						}
...
move.sfpk10_gamePlayType=move.server+'/api/gfSfPk10_gamePlayType';
move.sfpk10_betPanel=move.server+'/api/gfSfPk10_betPanel';
move.sfpk10_sessionInfo=move.server+'/api/gfSfPk10_sessionInfo';
move.sfpk10_openList=move.server+'/api/gfSfPk10_openList';
move.sfpk10_latestLottery=move.server+'/api/gfSfPk10_latestLottery';
move.sfpk10_bet=move.server+'/api/gfSfPk10_bet';
move.sfpk10_winRanking=move.server+'/api/gfSfPk10_winRanking';
