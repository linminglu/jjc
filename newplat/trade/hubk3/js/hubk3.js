				...
				if(code=='200'){
					...
					if(length==0){
						if(timeropenresult==null){
							timeropenresult=window.setInterval(function(){timerObj.result('timer-hubk3open');},timerObj.intervalAPI);
						}
					}else{
					...
					if(timerxiazhu==null){
						timerxiazhu=window.setInterval(function(){timerObj.init(timerObj.rest,'timer-hubk3');},timerObj.interval); 
					}
					if(timeropen==null){
						timeropen=window.setInterval(function(){timerObj.open(timerObj.openrest,'timer-hubk3open');},timerObj.interval);
					}
...
move.hubK3_gamePlayType=move.server+'/api/gfHubK3_gamePlayType';
move.hubK3_betPanel=move.server+'/api/gfHubK3_betPanel';
move.hubK3_sessionInfo=move.server+'/api/gfHubK3_sessionInfo';
move.hubK3_openList=move.server+'/api/gfHubK3_openList';
move.hubK3_latestLottery=move.server+'/api/gfHubK3_latestLottery';
move.hubK3_bet=move.server+'/api/gfHubK3_bet';
move.hubK3_winRanking=move.server+'/api/gfHubK3_winRanking';
move.hubK3_trend=move.server+'/api/gfHubK3_trend';
