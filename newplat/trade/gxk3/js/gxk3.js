				...
				if(code=='200'){
					...
					if(length==0){
						if(timeropenresult==null){
							timeropenresult=window.setInterval(function(){timerObj.result('timer-gxk3open');},timerObj.intervalAPI);
						}
					}else{
					...
					if(timerxiazhu==null){
						timerxiazhu=window.setInterval(function(){timerObj.init(timerObj.rest,'timer-gxk3');},timerObj.interval); 
					}
					if(timeropen==null){
						timeropen=window.setInterval(function(){timerObj.open(timerObj.openrest,'timer-gxk3open');},timerObj.interval);
					}
...
move.gxK3_gamePlayType=move.server+'/api/gfGxK3_gamePlayType';
move.gxK3_betPanel=move.server+'/api/gfGxK3_betPanel';
move.gxK3_sessionInfo=move.server+'/api/gfGxK3_sessionInfo';
move.gxK3_openList=move.server+'/api/gfGxK3_openList';
move.gxK3_latestLottery=move.server+'/api/gfGxK3_latestLottery';
move.gxK3_bet=move.server+'/api/gfGxK3_bet';
move.gxK3_winRanking=move.server+'/api/gfGxK3_winRanking';
move.gxK3_trend=move.server+'/api/gfGxK3_trend';
