...
//			var type=$(this).attr('type');
	...
	gamePlayType:function(){
		...
		$.ajax({
			type: "POST",
			url:move.gdPick11_gamePlayType,
			dataType:'json',
			data:{
				mw:mw
			},
...
move.gdPick11_gamePlayType=move.server+'/api/gfGdPick11_gamePlayType';
move.gdPick11_betPanel=move.server+'/api/gfGdPick11_betPanel';
move.gdPick11_sessionInfo=move.server+'/api/gfGdPick11_sessionInfo';
move.gdPick11_openList=move.server+'/api/gfGdPick11_openList';
move.gdPick11_latestLottery=move.server+'/api/gfGdPick11_latestLottery';
move.gdPick11_bet=move.server+'/api/gfGdPick11_bet';
move.gdPick11_winRanking=move.server+'/api/gfGdPick11_winRanking';
move.gdPick11_trend=move.server+'/api/gfGdPick11_trend';
