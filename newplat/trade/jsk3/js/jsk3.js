...
move.jsK3_gamePlayType=move.server+'/api/gfJsK3_gamePlayType';
move.jsK3_betPanel=move.server+'/api/gfJsK3_betPanel';
move.jsK3_sessionInfo=move.server+'/api/gfJsK3_sessionInfo';
move.jsK3_openList=move.server+'/api/gfJsK3_openList';
move.jsK3_latestLottery=move.server+'/api/gfJsK3_latestLottery';
move.jsK3_bet=move.server+'/api/gfJsK3_bet';
move.jsK3_winRanking=move.server+'/api/gfJsK3_winRanking';
move.jsK3_trend=move.server+'/api/gfJsK3_trend';
