...
move.cqSsc_gamePlayType=move.server+'/api/gfCqSsc_gamePlayType';
move.cqSsc_betPanel=move.server+'/api/gfCqSsc_betPanel';
move.cqSsc_sessionInfo=move.server+'/api/gfCqSsc_sessionInfo';
move.cqSsc_openList=move.server+'/api/gfCqSsc_openList';
move.cqSsc_latestLottery=move.server+'/api/gfCqSsc_latestLottery';
move.cqSsc_bet=move.server+'/api/gfCqSsc_bet';
move.cqSsc_winRanking=move.server+'/api/gfCqSsc_winRanking';
