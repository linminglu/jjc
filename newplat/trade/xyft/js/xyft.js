				...
				if(code=='200'){
					...
					if(length==0){
						...
						for (var i = 0; i < resultItems.length; i++) {
							...
							html=html+'<span class="num '+className+' xyft_num">'+num+'</span>';
						}
...
move.xyft_gamePlayType=move.server+'/api/gfXyFt_gamePlayType';
move.xyft_betPanel=move.server+'/api/gfXyFt_betPanel';
move.xyft_sessionInfo=move.server+'/api/gfXyFt_sessionInfo';
move.xyft_openList=move.server+'/api/gfXyFt_openList';
move.xyft_latestLottery=move.server+'/api/gfXyFt_latestLottery';
move.xyft_bet=move.server+'/api/gfXyFt_bet';
move.xyft_winRanking=move.server+'/api/gfXyFt_winRanking';
move.xyft_trend=move.server+'/api/gfXyFt_trend';
