...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    		...
    		<!--
			<span>开始时间：<html:text property="startDate" name="sfPk10Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty sfPk10Form.sfPk10Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="sfPk10Form" property="sfPk10Dto.totalPoint"/></td>
		<td><bean:write name="sfPk10Form" property="sfPk10Dto.winCash"/></td>
		<td><bean:write name="sfPk10Form" property="sfPk10Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
