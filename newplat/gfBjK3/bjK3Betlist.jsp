...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
    	...
    	期号:<html:text property="sessionNo"/>	
			<span>时间范围：<html:text property="startDate" name="bjK3Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="bjK3Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
