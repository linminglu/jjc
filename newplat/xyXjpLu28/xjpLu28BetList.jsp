...
<body>
<html:form action="/xjpLu28Action.do?method=betList">
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
    	...
    	<!--
			<span>时间范围：<html:text property="startDate" name="xjpLu28Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="xjpLu28Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty xjpLu28Form.xjpLu28BetDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="xjpLu28Form" property="xjpLu28BetDto.totalPoint"/></td>
		<td><bean:write name="xjpLu28Form" property="xjpLu28BetDto.winCash"/></td>
		<td><bean:write name="xjpLu28Form" property="xjpLu28BetDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
