...
<body>
<html:form action="/bjK3Action.do?method=betList">
<html:hidden property="startIndex" name="bjK3Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>
    	<!--	
			<span>开始时间：<html:text property="startDate" name="bjK3Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>结束时间：<html:text property="endDate" name="bjK3Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty bjK3Form.bjk3betDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="bjK3Form" property="bjk3betDto.totalPoint"/></td>
		<td><bean:write name="bjK3Form" property="bjk3betDto.winCash"/></td>
		<td><bean:write name="bjK3Form" property="bjk3betDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
