...
<body>
<html:form action="/xyFtAction.do?method=betList">
<html:hidden property="startIndex" name="xyFtForm"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
			<span>时间范围：<html:text property="startDate" name="xyFtForm" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="xyFtForm" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty xyFtForm.gfXyftDto}">
	<tr style="background:#ddd">
		<td colspan="3"></td>
		<td>合计</td>
		<td><bean:write name="xyFtForm" property="gfXyftDto.totalPoint"/></td>
		<td><bean:write name="xyFtForm" property="gfXyftDto.winCash"/></td>
		<td><bean:write name="xyFtForm" property="gfXyftDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
