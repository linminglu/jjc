...
<body>
<html:form action="/sdPick11Action.do?method=betList">
<html:hidden property="startIndex" name="sdPick11Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
    	<!--
			<span>时间范围：<html:text property="startDate" name="sdPick11Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="sdPick11Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty sdPick11Form.sdpick11Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="sdPick11Form" property="sdpick11Dto.totalPoint"/></td>
		<td><bean:write name="sdPick11Form" property="sdpick11Dto.winCash"/></td>
		<td><bean:write name="sdPick11Form" property="sdpick11Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
