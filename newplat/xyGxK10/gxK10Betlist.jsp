...
<body>
<html:form action="/gxK10Action.do?method=betList">
<html:hidden property="startIndex" name="gxK10Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
    	<!--
			<span>时间范围：<html:text property="startDate" name="gxK10Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="gxK10Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty gxK10Form.gxk10Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="gxK10Form" property="gxk10Dto.totalPoint"/></td>
		<td><bean:write name="gxK10Form" property="gxk10Dto.winCash"/></td>
		<td><bean:write name="gxK10Form" property="gxk10Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
