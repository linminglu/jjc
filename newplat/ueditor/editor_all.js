...
//cuisy
UE.commands['bxsptextbox'] = {
	execCommand : function(){
		this.execCommand("insertHtml","<input type=\"text\" name=\"bxsptextbox\" class=\"bxsptextbox\"/>");
	}
};
...
(function () {
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable','bxsptextbox'];
