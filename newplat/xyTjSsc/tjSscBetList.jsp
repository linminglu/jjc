...
<body>
<html:form action="/tjSscAction.do?method=betList">
<html:hidden property="startIndex" name="tjSscForm"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
    	  <!--
			<span>时间范围：<html:text property="startDate" name="tjSscForm" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="tjSscForm" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    	-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty tjSscForm.tjSscDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="tjSscForm" property="tjSscDto.totalPoint"/></td>
		<td><bean:write name="tjSscForm" property="tjSscDto.winCash"/></td>
		<td><bean:write name="tjSscForm" property="tjSscDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
