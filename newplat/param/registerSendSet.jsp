...
function modify(id){
	document.forms[0].action = "paramAction.do?method=preRegisterSendSetModify&action=modif&paramId="+id;
...
<body>
<div class="bread">系统管理  &raquo;  会员注册赠送金额设置</div>
<html:form action="/paramAction.do?method=registerSendSet">
</html:form>
