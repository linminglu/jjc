...
function modify(id){
	document.forms[0].action = "paramAction.do?method=preSignSendSetModify&action=modif&paramId="+id;
...
<body>
<div class="bread">系统管理  &raquo;  签到赠送金额设置</div>
<html:form action="/paramAction.do?method=signSendSet">
</html:form>
