...
function modify(id){
	document.forms[0].action = "paramAction.do?method=preTaskSendSetModify&action=modif&paramId="+id;
...
<body>
<div class="bread">系统设置  &raquo; 任务赚钱设置</div>
<html:form action="/paramAction.do?method=taskSendSet">
</html:form>
