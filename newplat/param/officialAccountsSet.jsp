...
function modify(id){
	document.forms[0].action = "paramAction.do?method=preOfficialAccountsSetModify&action=modif&paramId="+id;
...
<body>
<div class="bread">系统设置  &raquo;  线下充值开关</div>
<html:form action="/paramAction.do?method=officialAccountsSet">
</html:form>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	...
	<tr class="tr-color-body" onmousemove="this.style.background='#EEE'" onmouseout="this.style.background='#FFF'">
		...
		<td>
				<img src="..<bean:write property="value" name="param"/>"/>		
		</td>
	    <td align="center">
