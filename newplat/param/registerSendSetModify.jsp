...
<body>
<div class="bread">
<c:if test = "${paramForm.type==15}">注册会员赠送金额设置 </c:if>
<logic:notEmpty name="paramForm" property="param.paramId">修改</logic:notEmpty>
</div>
<html:form action="/paramAction.do?method=saveRegisterSendSet" onsubmit="return formSubmit();" enctype="multipart/form-data">
