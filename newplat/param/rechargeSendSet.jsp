...
function modify(id){
	document.forms[0].action = "paramAction.do?method=preRechargeSendSetModify&action=modif&paramId="+id;
...
<body>
<div class="bread">系统设置  &raquo;  会员每次充值系统赠送设置</div>
<html:form action="/paramAction.do?method=rechargeSendSet">
</html:form>
