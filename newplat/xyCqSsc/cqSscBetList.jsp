...
<body>
<html:form action="/cqSscAction.do?method=betList">
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
    	...
    	期号:<html:text property="sessionNo"/>	
    	  <!--
			<span>时间范围：<html:text property="startDate" name="cqSscForm" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="cqSscForm" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    	-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty cqSscForm.cqsscDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="cqSscForm" property="cqsscDto.totalPoint"/></td>
		<td><bean:write name="cqSscForm" property="cqsscDto.winCash"/></td>
		<td><bean:write name="cqSscForm" property="cqsscDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
