	...
	$.post("managerAction.do?method=view&tradeDetailId="+id, 
		function(data) {
	        ...
	        if (code == "200") {
	        	...
	        	html=html+'<table class="layui-table"><colgroup><col width="10"><col width="20"><col></colgroup><thead><tr><th>订单号</th><th>期号</th><th>玩法</th><th>投注项</th><th>投注额</th><th>中奖状态</th><th>奖金</th></tr></thead><tbody>'
	        	for(var i = 0; i < length; i++){
	        	    ...
	        	    html=html+'<tr><td>'+obj.betDetailId+'</td><td>'+sessionNo+'</td><td>'+betName+'</td><td style="word-break: break-all;">'+optionTitle+
...
<html:form action="/managerAction.do?method=balanceDetail">
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	...
	<tr class="moon">
		<td>
		<span>期号：<html:text property="sessionNo" name="managerForm"/></span>
		<span>订单号：<html:text property="betDetailId" name="managerForm" style="width:100px;"/></span>
			<span>
			彩票类型：
			<html:select property="gameType" name="managerForm" styleClass="sele select" style="width:174px;">;		
				<html:option value="">全部</html:option>			
				<optgroup label="------------信用------------"></optgroup>
				<logic:notEmpty name="gaXyList">
      				<html:options collection="gaXyList"  property="gameType" labelProperty="gameTitle"/>
	      		</logic:notEmpty>
	      		<optgroup label="------------官方------------"></optgroup>
			...
			<html:select property="cashType" name="managerForm" styleClass="sele select">
				...
				<html:option value="4">分销佣金</html:option>
				...
				<html:option value="15">系统扣款</html:option>
				<html:option value="16">注册赠送</html:option>
				<html:option value="18">中奖彩派</html:option>
				<html:option value="19">代理返点</html:option>
				<html:option value="27">管理员充值</html:option>
				<html:option value="28">其他加款</html:option>
				<html:option value="29">其他扣款</html:option>
				<html:option value="30">修复明细加款</html:option>
				<html:option value="31">修复明细扣款</html:option>
				<html:option value="32">会员充值返水给代理</html:option>
				<html:option value="33">会员打码返水给代理</html:option>
				<html:option value="34">会员充值系统赠送</html:option>
				<html:option value="35">会员打码返水给自己</html:option>
				<html:option value="36">签到赠送</html:option>
				<html:option value="37">转盘获得</html:option>
				<html:option value="38">红包获得</html:option>
				<html:option value="39">充值跳级奖励</html:option>
			</html:select>
			</span>
...
String sessionNo =request.getAttribute("sessionNo")!=null?(String)request.getAttribute("sessionNo"):"";
...
<pg:pager 
	...
	scope="request"> 
	<pg:param name="method" value="balanceDetail"/>
