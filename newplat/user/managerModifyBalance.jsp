...
function formSubmit(){
	...
	if(frm["type"].value.trim().length==0){
		alert("请选择加款类型");
		frm["type"].focus();
		return false;
	}
...
<html:form action="/managerAction.do?method=modifyBalance" onsubmit="return formSubmit();" enctype="multipart/form-data">
...
<html:hidden property="user.loginName" name="managerForm"/> 
...
<table class="tblistadd" border="0" cellpadding="0" cellspacing="1">
    ...
    <tr class="tr-color-body">
      	<th align="right">加款类型</th>
      	<td>
        	<html:select property="type" name="managerForm" styleClass="sele">
				<html:option value="">请选择</html:option>
				<html:option value="1">正常加款</html:option>
				<html:option value="0">其他加款</html:option>
			</html:select>
      	</td>
    </tr>
    <tr class="tr-color-body">
