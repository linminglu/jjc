...
<html:form action="/managerAction.do?method=userListByBalance" method="post">
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
			...
			<span>银行卡号：<html:text style="width: 130px;" property="accountNo" name="managerForm"/></span>
			<span>状态：
...
<pg:pager 
	...
	scope="request"> 
	<pg:param name="method" value="userListByBalance"/>
	  ...
	  <!-- 
		...
		<td align="center">
	   	...
	   	<td align="center">
			...
			<a class="link" href='../agent/agentAction.do?method=agentReport&userId=<bean:write name="item" property="userId"/>&usType=<c:out value="${item.userType}"/>'>报表</a>
