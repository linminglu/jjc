...
<body>
<div class="bread">用户管理  &raquo师徒列表; 
</div>
<html:form action="/managerAction.do?method=masterPrentice" method="post">
...
<pg:pager 
	...
	scope="request"> 
	<pg:param name="method" value="masterPrentice"/>
...
<table class="tblist" border="0" cellpadding="0" cellspacing="0">
	...
	<tr onmousemove="this.style.background='#EEEEEE'" onmouseout="this.style.background='#ffffff'">
	    ...
	    <td align="center">
		    <bean:write name="item" property="invitationCode"/>
		</td>
	</tr>
	</pg:item>
	</logic:iterate>
