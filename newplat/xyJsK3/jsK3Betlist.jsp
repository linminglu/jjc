...
<body>
<html:form action="/jsK3Action.do?method=betList">
<html:hidden property="startIndex" name="jsK3Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>
    	<!--	
			<span>时间范围：<html:text property="startDate" name="jsK3Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="jsK3Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    		-->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty jsK3Form.jsk3Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="jsK3Form" property="jsk3Dto.totalPoint"/></td>
		<td><bean:write name="jsK3Form" property="jsk3Dto.winCash"/></td>
		<td><bean:write name="jsK3Form" property="jsk3Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
