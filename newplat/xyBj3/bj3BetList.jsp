...
<body>
<html:form action="/bj3Action.do?method=betList">
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
    	...
    	<!--
    	<span>时间范围：<html:text property="startDate" name="bj3Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;<html:text property="endDate" name="bj3Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
    	 -->
...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty bj3Form.bj3Dto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="bj3Form" property="bj3Dto.totalPoint"/></td>
		<td><bean:write name="bj3Form" property="bj3Dto.winCash"/></td>
		<td><bean:write name="bj3Form" property="bj3Dto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
