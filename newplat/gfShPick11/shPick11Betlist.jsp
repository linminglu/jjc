...
<body>
<html:form action="/shPick11Action.do?method=betList">
<html:hidden property="startIndex" name="shPick11Form"/>
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<tr class="moon">
		<td>
    	期号:<html:text property="sessionNo"/>	
			<span>时间范围：<html:text property="startDate" name="shPick11Form" styleClass="Wdate" styleId="startTime"   onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
			<span>——&nbsp;&nbsp;：<html:text property="endDate" name="shPick11Form" styleClass="Wdate" styleId="endDate"  onclick="WdatePicker({lang:'zh-cn'})" readonly="readonly"/></span>
