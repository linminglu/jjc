...
<table class="tblist" cellpadding="0" cellspacing="0" border="0">
	<c:if test ="${not empty xyftForm.xyftDto}">
	<tr style="background:#ddd">
		<td></td>
		<td>合计</td>
		<td><bean:write name="xyftForm" property="xyftDto.totalPoint"/></td>
		<td><bean:write name="xyftForm" property="xyftDto.winCash"/></td>
		<td><bean:write name="xyftForm" property="xyftDto.payoff"/></td>
	</tr>
	</c:if>
	<tr>
		<th class="sel">序号</th>
