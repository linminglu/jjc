...
Popup.prototype = {
    ...
    build: function() {
        ...
        var path = "./js/closewin.gif";
        var close = '<input type="image" id="dialogBoxClose" src="' + path + '" border="0" width="16" height="16" style="cursor:pointer" align="absmiddle" title="关闭"/>';
