...
<%@page import="com.gzlm.util.UploadUtil_Zang"%>
...
// 	imagepath1=uploadtype+"/"+uid+"_big.jpg";
	imagepath2=uploadtype+"/"+uid+"_middle.jpg";
	imagepath3=uploadtype+"/"+uid+"_small.jpg";
...
// 		{
// 			设置图片
// 			window.opener.document.getElementById("imgpath1").value=img2;
// 			设置路径
// 			window.opener.document.getElementById("showimg1").src="../upload/"+img2;
// 		}
		window.opener.location="../user/userAction.do?method=uploadLogo&logoSrc=/upload/"+img2+"&logoMiniSrc=/upload/"+img3;
		window.close();
	}
	</script>
	</head>
...
// 		System.out.println(action);
		UploadUtil_Zang uploadUtil = new UploadUtil_Zang();
		...
		//上传附件
		boolean boo = uploadUtil.uploadFile("");
		if (isOk == false)
		{
			System.out.println("页面出错：" + uploadUtil.getMsg());
			return;
...
// 	String avatar1 = request.getParameter("avatar1");//大,原始截图
	String avatar2 = request.getParameter("avatar2");//中,等比例缩小图
	String avatar3 = request.getParameter("avatar3");//小,48*48
	String output ="";
