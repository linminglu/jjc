package com.gf.k3.bjk3.model.dto;
...
public class GfBjK3DTO {
	...
	public GfBjK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfBjK3DTO(String sessionNo,BigDecimal totalPoint,
