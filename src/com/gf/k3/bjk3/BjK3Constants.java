package com.gf.k3.bjk3;

public class BjK3Constants {

	public final static String BJ_K3_START_TIME_STR=" 09:00:00";//游戏开始时间第一期
	public final static Integer BJ_K3_MAX_PART=89;//最大场次
	public final static Integer BJ_K3_TIME_INTERVAL=10;//场次间隔分钟
	
	public final static Integer BJK3_TIME_OPENING_FREEZE=60;//[秒]开奖中冻结期，即可不允许在投注，等官网开奖
	
	public final static String BJ_K3_OPEN_STATUS_INIT = "0";//0=未开奖 1=开奖中  2=已开奖
	public final static String BJ_K3_OPEN_STATUS_OPENING = "1";//0=未开奖 1=开奖中  2=已开奖
	public final static String BJ_K3_OPEN_STATUS_OPENED = "2";//0=未开奖 1=开奖中  2=已开奖
