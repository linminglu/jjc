package com.gf.k3.jsk3.model.dto;
...
public class GfJsK3DTO {
	...
	public GfJsK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfJsK3DTO(String sessionNo,BigDecimal totalPoint,
