package com.gf.k3.gxk3.model.dto;
...
public class GfGxK3DTO {
	...
	public GfGxK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfGxK3DTO(String sessionNo,BigDecimal totalPoint,
