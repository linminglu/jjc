package com.gf.k3.hubk3.model.dto;
...
public class GfHubK3DTO {
	...
	public GfHubK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfHubK3DTO(String sessionNo,BigDecimal totalPoint,
