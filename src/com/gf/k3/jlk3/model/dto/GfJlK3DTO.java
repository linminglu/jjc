package com.gf.k3.jlk3.model.dto;
...
public class GfJlK3DTO {
	...
	public GfJlK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfJlK3DTO(String sessionNo,BigDecimal totalPoint,
