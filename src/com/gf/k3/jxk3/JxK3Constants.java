package com.gf.k3.jxk3;

public class JxK3Constants {

	public final static String JX_K3_START_TIME_STR=" 08:30:00";//游戏开始时间第一期
	public final static Integer JX_K3_MAX_PART=82;//最大场次
	public final static Integer JX_K3_TIME_INTERVAL=10;//场次间隔分钟
	
	public final static Integer JXK3_TIME_OPENING_FREEZE=60;//[秒]开奖中冻结期，即可不允许在投注，等官网开奖
	
	public final static String JX_K3_OPEN_STATUS_INIT = "0";//0=未开奖 1=开奖中  2=已开奖
	public final static String JX_K3_OPEN_STATUS_OPENING = "1";//0=未开奖 1=开奖中  2=已开奖
	public final static String JX_K3_OPEN_STATUS_OPENED = "2";//0=未开奖 1=开奖中  2=已开奖
