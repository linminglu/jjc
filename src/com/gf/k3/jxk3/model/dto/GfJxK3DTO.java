package com.gf.k3.jxk3.model.dto;
...
public class GfJxK3DTO {
	...
	public GfJxK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfJxK3DTO(String sessionNo,BigDecimal totalPoint,
