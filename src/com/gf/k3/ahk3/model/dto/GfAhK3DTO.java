package com.gf.k3.ahk3.model.dto;
...
public class GfAhK3DTO {
	...
	public GfAhK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfAhK3DTO(String sessionNo,BigDecimal totalPoint,
