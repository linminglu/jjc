package com.gf.k3.shk3.model.dto;
...
public class GfShK3DTO {
	...
	public GfShK3DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfShK3DTO(String sessionNo,BigDecimal totalPoint,
