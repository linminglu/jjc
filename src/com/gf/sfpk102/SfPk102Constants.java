...
public class SfPk102Constants {
	...
	public final static String SF_PK102_OPEN_STATUS_INIT = "0";//0=未开奖 
	public final static String SF_PK102_OPEN_STATUS_OPENING = "1";//1=开奖中
	public final static String SF_PK102_OPEN_STATUS_OPENED = "2";//2=已开奖
	
	public final static Integer SF_PK102_MAX_BET_POINT = 100000; //单注投注最大值1万。
