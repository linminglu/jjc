package com.gf.sfpk102.model.dto;
...
public class GfSfPk102DTO {
	...
	public GfSfPk102DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfSfPk102DTO(BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
		this.totalPoint = totalPoint;
		this.winCash = winCash;
		this.payoff = payoff;
	}
	public GfSfPk102DTO(String sessionNo,BigDecimal totalPoint,
