...
public class ThreeUtil {
	...
	public static int getTotalBetNum(String playType,String betBall){
		int totalBet =0;
		if(ThreeConstants.PLAY_TYPE_ZERO.equals(playType)){//大小单双
		...
		}else if(ThreeConstants.PLAY_TYPE_ONE.equals(playType)){//一星
			char[] unit = betBall.toCharArray();
			int unitNum =unit.length;
			totalBet = totalBet + unitNum;
		}else if(ThreeConstants.PLAY_TYPE_TWO.equals(playType)){//二星组选
			String[] grou = betBall.split(",");
			int unitNum =ThreeUtil.getTotal(grou.length,2);
			totalBet = totalBet + unitNum;
		}else if(ThreeConstants.PLAY_TYPE_THREE.equals(playType)){//二星直选
			char[] tents = betBall.split(",")[0].toCharArray();
			char[] unit = betBall.split(",")[1].toCharArray();
			int tentsNum = tents.length;
			int unitNum =unit.length;
			totalBet = totalBet + tentsNum*unitNum;
		}else if(ThreeConstants.PLAY_TYPE_FOUR.equals(playType)){//三星组六
			String[] grou = betBall.split(",");
			int unitNum =ThreeUtil.getTotal(grou.length,3);
			totalBet = totalBet + unitNum;
		}else if(ThreeConstants.PLAY_TYPE_FIVE.equals(playType)){//三星组三
			String[] grou = betBall.split(",");
			int unitNum =ThreeUtil.getTotal(grou.length,2);
			totalBet = totalBet + unitNum*2;
		}else if(ThreeConstants.PLAY_TYPE_SIX.equals(playType)){//三星直选
			char[] tents = betBall.split(",")[0].toCharArray();
			char[] unit = betBall.split(",")[1].toCharArray();
		...
		}else if(ThreeConstants.PLAY_TYPE_SEVEN.equals(playType)){//五星直选
			char[] tents = betBall.split(",")[0].toCharArray();
			char[] unit = betBall.split(",")[1].toCharArray();
			char[] percent = betBall.split(",")[2].toCharArray();
			...
			totalBet = totalBet + tentsNum*unitNum *percentNum*thousandNum*extremeNum;
		}else if(ThreeConstants.PLAY_TYPE_EIGHT.equals(playType)){//三星组三
			char[] tents = betBall.split(",")[0].toCharArray();
			char[] unit = betBall.split(",")[1].toCharArray();
			char[] percent = betBall.split(",")[2].toCharArray();
			char[]  thousand = betBall.split(",")[3].toCharArray();
...
//		  System.out.println("数据长度 " + list.size());
	 ...
	 public static String getAfterThree(String openResult){
		 String[] re = openResult.split(",");
		 if(re.length >= 4){
			 if(re[2].equals(re[3])&&re[2].equals(re[4])){
				 return "豹子";
			 }else if(!re[2].equals(re[3])&&!re[2].equals(re[4])&&!re[3].equals(re[4])){
				 return "组六";
			 }else{
				 return "组三";
			 }
	...
	public static BigDecimal judgeWinMoney(String playType, String betBall,
		...
		if(ThreeConstants.PLAY_TYPE_ZERO.equals(playType)){
			...
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_ONE.equals(playType)){
			char ball;//单个球
			...
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_TWO.equals(playType)){
			...
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_THREE.equals(playType)){
			if(betBall.split(",")[0].contains(results[3])&&betBall.split(",")[1].contains(results[4])){
				winMoney = winMoney.add(betRate);
			}
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_FOUR.equals(playType)){
			if(!results[2].equals(results[3])&&!results[2].equals(results[4])&&!results[3].equals(results[4])){
...
//				}
			...
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_FIVE.equals(playType)){
...
//					winMoney = winMoney.add(betRate);
//				}
			}else if(results[2].equals(results[4])&&!results[2].equals(results[3])){
				String[]array = betBall.split(",");
				int num = 0;
				boolean is2=true;
				boolean is3=true;
...
//					winMoney = winMoney.add(betRate);
//				}
			}else if(results[3].equals(results[4])&&!results[2].equals(results[3])){
				String[]array = betBall.split(",");
				int num = 0;
				boolean is2=true;
				boolean is3=true;
...
//				}
			...
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_SIX.equals(playType)){
			if(betBall.split(",")[0].contains(results[2])&&betBall.split(",")[1].contains(results[3])&&betBall.split(",")[2].contains(results[4])){
				winMoney = winMoney.add(betRate);
			}
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_SEVEN.equals(playType)){
			if(betBall.split(",")[0].contains(results[0])&&betBall.split(",")[1].contains(results[1])&&betBall.split(",")[2].contains(results[2])
					&&betBall.split(",")[3].contains(results[3])&&betBall.split(",")[4].contains(results[4])){
				winMoney = winMoney.add(betRate);
			}
			return winMoney;
		}else if(ThreeConstants.PLAY_TYPE_EIGHT.equals(playType)){
			if(betBall.split(",")[0].contains(results[0])&&betBall.split(",")[1].contains(results[1])&&betBall.split(",")[2].contains(results[2])
					&&betBall.split(",")[3].contains(results[3])&&betBall.split(",")[4].contains(results[4])){
				//五星通选一等奖
				winMoney = winMoney.add(betRate);
			}else if((betBall.split(",")[0].contains(results[0])&&betBall.split(",")[1].contains(results[1])&&betBall.split(",")[2].contains(results[2]))
					||(betBall.split(",")[2].contains(results[2])&&betBall.split(",")[3].contains(results[3])&&betBall.split(",")[4].contains(results[4]))){
				//"五星通选"二等奖，奖金220元
				winMoney = winMoney.add(new BigDecimal(220));
			}else{
				if(betBall.split(",")[0].contains(results[0])&&betBall.split(",")[1].contains(results[1])){
					winMoney = winMoney.add(new BigDecimal(20));
				}
				if(betBall.split(",")[3].contains(results[3])&&betBall.split(",")[4].contains(results[4])){
					winMoney = winMoney.add(new BigDecimal(20));
				}
			}
			return winMoney;
