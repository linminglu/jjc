...
public class JsFtConstants {
	...
	public final static String JS_FT_START_TIME_STR=" 00:00:00";//游戏开始时间第一期
	public final static Integer JS_FT_MAX_PART=960;//最大场次
	public final static Integer JS_FT_TIME_INTERVAL=90;//场次间隔90秒
	
	public final static Integer JS_FT_TIME_OPENING_FREEZE = 18;//[秒]开奖中冻结期，即可不允许在投注，等官网开奖
	public final static String JS_FT_OPEN_STATUS_INIT = "0";//0=未开奖 
	public final static String JS_FT_OPEN_STATUS_OPENING = "1";//1=开奖中
	public final static String JS_FT_OPEN_STATUS_OPENED = "2";//2=已开奖
	
	public final static Integer JS_FT_MAX_BET_POINT = 100000; //单注投注最大值1万。
