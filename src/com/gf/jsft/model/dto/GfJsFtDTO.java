...
public class GfJsFtDTO {
	...
	public GfJsFtDTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}
	
	public GfJsFtDTO(BigDecimal totalPoint,
	...
	public GfJsFtDTO(String sessionNo,BigDecimal totalPoint,
