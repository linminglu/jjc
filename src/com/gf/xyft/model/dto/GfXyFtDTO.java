...
public class GfXyFtDTO {
	...
	public GfXyFtDTO(GaBetSponsor gaSponsor,GaBetSponsorDetail gaBetSponsorDetail, User user){
		this.setGaSponsor(gaSponsor);
		this.setGaBetSponsorDetail(gaBetSponsorDetail);
		this.setUser(user);
	}

	public GfXyFtDTO(BigDecimal totalPoint,
	...
	public GfXyFtDTO(String sessionNo,BigDecimal totalPoint,
