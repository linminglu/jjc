package com.gf.sfpk10.model.dto;
...
public class GfSfPk10DTO {
	...
	public GfSfPk10DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfSfPk10DTO(BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
		this.totalPoint = totalPoint;
		this.winCash = winCash;
		this.payoff = payoff;
	}
	public GfSfPk10DTO(String sessionNo,BigDecimal totalPoint,
