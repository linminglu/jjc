package com.gf.bjpk10;

public class BjPk10Constants {

	public final static String BJ_PK10_START_TIME_STR=" 09:02:00";//游戏开始时间第一期
	public final static Integer BJ_PK10_MAX_PART=179;//最大场次
	public final static Integer BJ_PK10_TIME_INTERVAL=5;//场次间隔分钟
	
	public final static Integer BJ_PK10_TIME_OPENING_FREEZE = 60;//[秒]开奖中冻结期，即可不允许在投注，等官网开奖
	public final static String BJ_PK10_OPEN_STATUS_INIT = "0";//0=未开奖 
	public final static String BJ_PK10_OPEN_STATUS_OPENING = "1";//1=开奖中
	public final static String BJ_PK10_OPEN_STATUS_OPENED = "2";//2=已开奖
	
	public final static Integer BJ_PK10_MAX_BET_POINT = 100000; //单注投注最大值1万。
