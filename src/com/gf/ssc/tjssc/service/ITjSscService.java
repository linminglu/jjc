package com.gf.ssc.tjssc.service;
...
public interface ITjSscService   extends IService {
	 ...
	 * @return
	 */
	public User saveSponsorBet(GfTjSscGaSession se,int mutiple,User u,List<String> list,int num,int buyNum,String isGuaranteed,int gaNum,int betTotalNum,BigDecimal money,String isPrivacy);
	...
	public void updateFetchAndOpenOmit(GfTjSscGaSession session);
	/**
	 * 开奖，更新相关表
	 * @return
	 */
	 ...
	 * @return
	 */
	public String updateTjSscSessionOpenResultMethod(GfTjSscGaSession session,
			String openResult,String orderNum);
	/**
	 * 查询遗漏表数据  num是最大查询数量
	 */
	public List<GfTjSscGaOmit> findGfTjSscGaOmitList(String string,
			List<Object> para, int num);

	
	public PaginationSupport findGfTjSscGaSessionList(String string,
	 ...
	 * @return
	 */
	public String saveAndOpenResult(GfTjSscGaSession session, String openResult);
	
	/**
	 * 统计每日盈亏、每期盈亏。
	 */
	public void updateDayBetCount(GfTjSscGaSession session);
	/**
	 * 派彩错误，撤回已经派彩的金额
	 * @param session
	 * @return
