package com.gf.pick11.jxpick11.model.dto;
...
public class GfJxPick11DTO {
	...
	private User user;
	public GfJxPick11DTO(){
		
	}
	
	public GfJxPick11DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfJxPick11DTO(String sessionNo,BigDecimal totalPoint,
