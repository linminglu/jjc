package com.gf.pick11.ahpick11.model.dto;
...
public class GfAhPick11DTO {
	...
	private User user;
	public GfAhPick11DTO(){
		
	}
	
	public GfAhPick11DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfAhPick11DTO(String sessionNo,BigDecimal totalPoint,
