package com.gf.pick11.shpick11.model.dto;
...
public class GfShPick11DTO {
	...
	private User user;
	public GfShPick11DTO(){
		
	}
	
	public GfShPick11DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfShPick11DTO(String sessionNo,BigDecimal totalPoint,
