package com.gf.pick11.shpick11.util;
...
public class ShPick11Util {
	...
	public static BigDecimal judgeWinMoney(String playType, String betBall,
		...
		if(ShPick11Constants.GAME_TYPE_GF_QIANSANZHI.equals(playType)){//前三直选
//			String resultVal=results[0]+","+results[1]+","+results[2];
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_QIANSANZU.equals(playType)){//前三组选
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_QIANERZHI.equals(playType)){//前二直选
			String[] one = betBall.split("\\*")[0].split(",");
			String[] two = betBall.split("\\*")[1].split(",");
			int num1=0;
			int num2=0;
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_QIANERZU.equals(playType)){//前二组选
			String array[]=betBall.split(",");
			int num=0;
			for(int i=0;i<array.length;i++){//
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_QIANYI.equals(playType)){//前一
			String array[]=betBall.split(",");
			int num=0;
			for(int i=0;i<array.length;i++){//
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_RENBA.equals(playType)){//任八		
			String array[]=betBall.split(",");
			int num=0;
			for(int i=0;i<array.length;i++){//
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_RENQI.equals(playType)){//任七
			String array[]=betBall.split(",");
			int num=0;
			for(int i=0;i<array.length;i++){//
				if(array[i].equals(results[0])||array[i].equals(results[1])||array[i].equals(results[2])||array[i].equals(results[3])
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_RENLIU.equals(playType)){//任六
			String array[]=betBall.split(",");
			int num=0;
			for(int i=0;i<array.length;i++){//
				if(array[i].equals(results[0])||array[i].equals(results[1])||array[i].equals(results[2])||array[i].equals(results[3])
		...
		}else if(ShPick11Constants.GAME_TYPE_GF_RENWU.equals(playType)){//任五
			String array[]=betBall.split(",");
			int num=0;
			for(int i=0;i<array.length;i++){//
				if(array[i].equals(results[0])||array[i].equals(results[1])||array[i].equals(results[2])||array[i].equals(results[3])
