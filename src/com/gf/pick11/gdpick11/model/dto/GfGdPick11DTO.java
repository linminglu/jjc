package com.gf.pick11.gdpick11.model.dto;
...
public class GfGdPick11DTO {
	...
	private User user;
	public GfGdPick11DTO(){
		
	}
	
	public GfGdPick11DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfGdPick11DTO(String sessionNo,BigDecimal totalPoint,
