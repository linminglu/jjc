package com.gf.pick11.sdpick11.model.dto;
...
public class GfSdPick11DTO {
	...
	private User user;
	public GfSdPick11DTO(){
		
	}
	
	public GfSdPick11DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}

	public GfSdPick11DTO(String sessionNo,BigDecimal totalPoint,
