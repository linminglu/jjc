...
public class ActivityHibernate extends AbstractBaseDAOHibernate implements
		IActivityDAO {
	...
	public PaginationSupport findList(String hqls, List<Object> para,
		...
		String findList = "from Activity a where 1=1 ";
		String findCount = "select count(a.id) from Activity a where 1=1 ";
