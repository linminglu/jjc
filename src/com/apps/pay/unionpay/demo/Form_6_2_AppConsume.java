...
//		// 商户号码，请改成自己的商户号
//		data.put("merId", "898111453110343");
//		// 商户订单号，8-40位数字字母
...
//	public static Map<String, String> resmap(MytUserIndent order){
//		
...
//		data.put("frontUrl", "http://localhost:8080/ACPTest/acp_front_url.do");
//		// 后台通知地址 -- 同步支付通知
//		data.put("backUrl", RamConstants.PAY_UNION_NOTIFY_CALLBACK);
//		// 接入类型，商户接入填0 0- 商户 ， 1： 收单， 2：平台商户
//		data.put("accessType", "0");
//		// 商户号码，请改成自己的商户号
//		data.put("merId", RamConstants.PAY_UNION_PARTNER_ID);
//		// 商户订单号，8-40位数字字母
...
//		data.put("txnTime", new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()));
//		// 交易金额，单位分
//		BigDecimal payMoney=order.getMoney();
