...
public interface IAgentService extends IService {
	 ...
	 * @return
	 */
	public List<AgentDTO> findGameBetAndWin(String string, List<Object> para);
	/**
	 * 统计每种彩票的投注及中奖金额
	 * @param string
	 * @param para
	 * @return
	 */
	public List<AgentDTO> findGameBetAndWinFromUserTradeDetail(String string, List<Object> para);
	 ...
	 * @return
	 */
	public List<AgentDTO> findUserTradeStatistics(String string,
			List<Object> para);
	 ...
	 * @return
	 */
	public PaginationSupport findGaBetDetailList(String hql,
	 ...
	 * @return
	 */
	public List<AgentDTO> findUserTotalRecharge(String string, List<Object> para);
	 ...
	 * @return
	 */
	public List<AgentDTO> findUserTotalCharge(String string, List<Object> para);
