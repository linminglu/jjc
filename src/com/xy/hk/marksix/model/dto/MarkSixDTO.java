package com.xy.hk.marksix.model.dto;
...
public class MarkSixDTO {
    ...
    public MarkSixDTO(BigDecimal totalPoint,
	...
	public MarkSixDTO(String sessionNo,BigDecimal totalPoint,
	...
	public MarkSixDTO(GaBetDetail gaBetDetail, User user){
