package com.xy.k3.jsk3.service;
...
public interface IJsK3Service   extends IService {
	 ...
	 * 保存用户投注信息
	 */
	public void saveUserBetInfo(String room,Map<Integer,Integer> betMap,List<GaBetOption> list,JsK3GaSession session,User user,BigDecimal betAll);
	/**
	 * 冷热排行列表
	 * @return
	 */
...
//	public void updateFetchAndOpenTrendResult(Integer count);
	 ...
	 * @return
	 */
	public List<JsK3DTO> findGaBetDetailById(String string, List<Object> para);
