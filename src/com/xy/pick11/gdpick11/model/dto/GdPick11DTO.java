package com.xy.pick11.gdpick11.model.dto;
...
public class GdPick11DTO {
	...
	public GdPick11DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}
	public GdPick11DTO(BigDecimal totalPoint,
	...
	public GdPick11DTO(String sessionNo,BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
