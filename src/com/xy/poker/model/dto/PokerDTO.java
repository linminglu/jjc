package com.xy.poker.model.dto;
...
public class PokerDTO {
    ...
    public PokerDTO(BigDecimal totalPoint,
	...
	public PokerDTO(String sessionNo,BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
	...
	public PokerDTO(GaBetDetail gaBetDetail, User user){
