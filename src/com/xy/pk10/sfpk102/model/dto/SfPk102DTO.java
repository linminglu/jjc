package com.xy.pk10.sfpk102.model.dto;
...
public class SfPk102DTO {
	...
	public SfPk102DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}
	public SfPk102DTO(BigDecimal totalPoint,
	...
	public SfPk102DTO(String sessionNo,BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
