...
public class FetchSfPk102Result  extends QuartzJobBean {
	...
	private static ISfPk102Service sfPk1022Service;
	protected final Log log = LogFactory.getLog(getClass());
	
	public static ISfPk102Service getSfPk102Service() {
		return sfPk1022Service;
	}
	
	@SuppressWarnings("static-access")
	public void setSfPk102Service(ISfPk102Service sfPk1022Service) {
		this.sfPk1022Service = sfPk1022Service;
	}
	...
	int fetchMaxCount = GameHelpUtil.getFetchMaxCount(Constants.GAME_TYPE_XY_SFPK102);//最大抓取次数 
	int fetchDiffTime = GameHelpUtil.getFetchInterval(Constants.GAME_TYPE_XY_SFPK102);//抓取间隔毫秒
	int delayOpenTime = GameHelpUtil.getDelayOpenTime(Constants.GAME_TYPE_XY_SFPK102);//延迟开奖秒数(系统开) 
	...
	protected void executeInternal(JobExecutionContext arg0) throws JobExecutionException {
		...
		//定时有效范围
		if(!GameHelpUtil.checkTimerRange(Constants.GAME_TYPE_XY_SFPK102)){
		...
		GameHelpUtil.setFetchTimerMap(Constants.GAME_TYPE_XY_SFPK10, fetchTimer);
		TimerTask task = new TimerTask() {
	        @Override
	        public void run() {
	        	GaSessionInfo gsi = CacheUtil.getGaSessionInfo(Constants.GAME_TYPE_XY_SFPK102);//彩种缓存
	        	try {
	        		//当前系统时间
	        		Date now = DateTimeUtil.getJavaUtilDateNow();
	        		//当前时间期
	        		SfPk102GaSession curSession = sfPk1022Service.getCurrentSession();
	        		if(curSession==null){
	        		...
	        		//待开奖期
	        		SfPk102GaSession openSession = (SfPk102GaSession)sfPk1022Service.getObject(SfPk102GaSession.class,curSession.getSessionId()-1);
	        		if(openSession==null){
...
//	        		}
	        		...
	        		if(!opening){
	        			...
	        			if(sessionNoMap!=null && !sessionNoMap.isEmpty()){
	        				...
	        				String flag = sfPk1022Service.updateFetchAndOpenResult(sessionNoMap);
	        				if(flag.startsWith("success")){
	        					GameHelpUtil.removeOpening(Constants.GAME_TYPE_XY_SFPK102,openSessionNo);//移除开奖标识
