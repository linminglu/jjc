package com.xy.pk10.xyft.model.dto;
...
public class XyftDTO {
	...
	public XyftDTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}
	public XyftDTO(BigDecimal totalPoint,
	...
	public XyftDTO(String sessionNo,BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
