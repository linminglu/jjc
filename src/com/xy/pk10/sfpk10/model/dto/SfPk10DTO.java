package com.xy.pk10.sfpk10.model.dto;
...
public class SfPk10DTO {
	...
	public SfPk10DTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}
	public SfPk10DTO(BigDecimal totalPoint,
	...
	public SfPk10DTO(String sessionNo,BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
