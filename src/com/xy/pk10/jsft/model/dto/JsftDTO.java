package com.xy.pk10.jsft.model.dto;
...
public class JsftDTO {
	...
	public JsftDTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}
	public JsftDTO(BigDecimal totalPoint,
	...
	public JsftDTO(String sessionNo,BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
