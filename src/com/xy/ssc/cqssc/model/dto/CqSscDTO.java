package com.xy.ssc.cqssc.model.dto;
...
public class CqSscDTO {
	...
	public CqSscDTO(GaBetDetail gaBetDetail, User user){
		this.setGaBetDetail(gaBetDetail);
		this.setUser(user);
	}
	public CqSscDTO(BigDecimal totalPoint,
	...
	public CqSscDTO(String sessionNo,BigDecimal totalPoint,
			BigDecimal winCash,BigDecimal payoff){
