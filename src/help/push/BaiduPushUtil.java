...
//	/** 安卓 */
//	public static String APIKEY_ANDROID = Constants.BAIDU_PUSH_APIKEY_ANDROID;
//	public static String SECRETKEY_ANDROID = Constants.BAIDU_PUSH_SECRETKEY_ANDROID;
//	
//	/** IOS*/
//	public static String APIKEY_IOS = Constants.IOS_PUBLISH_MODE.equals(Constants.IOS_PUBLISH_MODE_INHOUSE)?Constants.BAIDU_PUSH_APIKEY_IOS_INHOUSE:Constants.BAIDU_PUSH_APIKEY_IOS_APPSTORE;
//	public static String SECRETKEY_IOS = Constants.IOS_PUBLISH_MODE.equals(Constants.IOS_PUBLISH_MODE_INHOUSE)?Constants.BAIDU_PUSH_SECRETKEY_IOS_INHOUSE:Constants.BAIDU_PUSH_SECRETKEY_IOS_APPSTORE;
//	
//	/** 普通通知 **/
...
//		//4278653909176945730 7056.android
//		//5723844623464862359 6270.ios
//		//3570103248307922268 6661.andriod
//		String token = "3540549150064296361";
//		// 1.普通通知
//		PushBean pushBean = new PushBean(TYPE_MSG, "通知", "通知内容"+StringUtil.getRandomNumberAndString(5));
...
//				"通知内容",Constants.MODULE_EAT, 1);
//		// iosPush(pushBean4, token);
//		// 5.用户订单详情
//		PushBean pushBean5 = new PushBean(TYPE_USER_ORDER_VIEW, "测试订单",
//				"测试订单",Constants.MODULE_STORE, 174);
//		// iosAllPush(pushBean2);
//		androidPush(pushBean, token);
//		//iosPush(pushBean, token);
//		// androidPush(pushBean3, token);
