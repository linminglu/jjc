package help.pay.lingdian.test.qry;
 ...
 *
 */
public class QryOneOrd {
		private static final String TxCode="210101";//210101-机构支付查询交易
	public static void main(String[] args) {
		  try{
			...
			map.put("TxSN","20170710180022");//商户交易流水号(唯一)
