 ...
 *
 */
public class WyB2CToPlat {
		private static final String TxCode="210112";//
		private static final String ProductId="0612";//产品类型:0612-网银B2C跳转收银台
	public static void main(String[] args) {
		  try{
			...
			map.put("ProductId",ProductId);//产品类型
